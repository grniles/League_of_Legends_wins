...
# Subtract number of wards placed by red team from blue team to make new column
...
# Create new variable based on wards destroyed
...
# Remove assists from dataset
league.data$blueAssists = NULL
league.data$redAssists = NULL

# Remove heralds from data set
league.data$blueHeralds = NULL
league.data$redHeralds = NULL

# Create new variable of difference of total towers destroyed
...
# Create new variable of difference in average level
...
# Create new variable of difference in minions kills
...
# Create new variable of difference in jungle minions killed
...
# Remove gold difference from dataset
...
# Summary of dataset with new variables
summary(league.data)

# Set up boundaries for stepwise logistic regression
...
# Run forwards stepwise regression
...
# so (cross-validated) proportion 0.731 of correct classifications  

# Create support vector machine using cost values 0.001, 0.01, 0.1, 1, 5, 10, 100 and gamma values 0.5, 1, 2, 3, 4
library(e1071)
